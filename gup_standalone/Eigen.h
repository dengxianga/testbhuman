...
#include "BHAssert.h" // Our Eigen extensions use ASSERT

// Extend the Eigen classes with our own methods (see: http://eigen.tuxfamily.org/dox-devel/TopicCustomizingEigen.html)
#define EIGEN_MATRIXBASE_PLUGIN "EigenMatrixBaseExtensions.h"
#define EIGEN_ARRAY_PLUGIN "EigenArrayExtensions.h"
